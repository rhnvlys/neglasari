    ...
    <div class="min-h-screen flex flex-col">
        ...
        <nav class="fixed bottom-0 inset-x-0 bg-white border-t border-neglasari-border py-2 z-40 shadow-lg">
            <div class="max-w-md mx-auto flex justify-around">
                ...
                @endphp
                <a href="{{ route('pegawai.dashboard') }}" class="flex flex-col items-center space-y-1 {{ $currentRoute === 'pegawai.dashboard' ? 'text-neglasari-main' : 'text-gray-400' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-6 h-6">
                      <path stroke-linecap="round" stroke-linejoin="round" d="m2.25 12 8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
                    </svg>
                    <span class="text-xs font-semibold">Beranda</span>
                </a>
                <a href="{{ route('pegawai.attendance.page') }}" class="flex flex-col items-center space-y-1 {{ str_starts_with($currentRoute, 'pegawai.attendance') ? 'text-neglasari-main' : 'text-gray-400' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-6 h-6">
                ...
                <a href="{{ route('pegawai.leave-requests.index') }}" class="flex flex-col items-center space-y-1 {{ str_starts_with($currentRoute, 'pegawai.leave-requests') ? 'text-neglasari-main' : 'text-gray-400' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-6 h-6">
