            ...
            <div class="border-t border-neglasari-border pt-6 mt-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="text" name="username" id="username" value="{{ old('username') }}" placeholder="Contoh: nandang" class="w-full px-3 py-2 border border-neglasari-border rounded-xl shadow-sm focus:outline-none focus:ring-neglasari-accent focus:border-neglasari-accent">
                        @error('username')
                            <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        <label for="password" class="block text-sm font-semibold text-neglasari-text mb-1">Password</label>
                        <input type="password" name="password" id="password" placeholder="Default: password123" class="w-full px-3 py-2 border border-neglasari-border rounded-xl shadow-sm focus:outline-none focus:ring-neglasari-accent focus:border-neglasari-accent">
                    </div>
                    ...
                    <div>
                        ...
                        <select name="role" id="role" class="w-full px-3 py-2 border border-neglasari-border rounded-xl shadow-sm focus:outline-none focus:ring-neglasari-accent focus:border-neglasari-accent">
                            <option value="Anggota" {{ old('role') === 'Anggota' ? 'selected' : '' }}>Anggota (Perangkat & Staf)</option>
                            <option value="Admin" {{ old('role') === 'Admin' ? 'selected' : '' }}>Admin (Staff IT Desa)</option>
                        </select>
                    </div>
                </div>
            </div>
