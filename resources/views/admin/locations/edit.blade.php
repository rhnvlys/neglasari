...
<div class="max-w-2xl mx-auto space-y-6">
    <div class="bg-white rounded-2xl shadow-lg p-6 border border-neglasari-border">
        ...
        <form action="{{ route('admin.locations.update', $location) }}" method="POST" class="space-y-4">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input type="text" name="name" id="name" value="{{ old('name', $location->name) }}" required class="w-full px-4 py-2 border border-neglasari-border rounded-xl focus:ring-neglasari-accent focus:border-neglasari-accent">
            ...
            <div>
                ...
                <textarea name="address" id="address" rows="2" required class="w-full px-4 py-2 border border-neglasari-border rounded-xl focus:ring-neglasari-accent focus:border-neglasari-accent">{{ old('address', $location->address) }}</textarea>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" step="any" name="latitude" id="latitude" value="{{ old('latitude', $location->latitude) }}" required class="w-full px-4 py-2 border border-neglasari-border rounded-xl font-mono focus:ring-neglasari-accent focus:border-neglasari-accent">
                ...
                <div>
                    ...
                    <input type="number" step="any" name="longitude" id="longitude" value="{{ old('longitude', $location->longitude) }}" required class="w-full px-4 py-2 border border-neglasari-border rounded-xl font-mono focus:ring-neglasari-accent focus:border-neglasari-accent">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" name="radius_meters" id="radius_meters" value="{{ old('radius_meters', $location->radius_meters) }}" min="1" required class="w-full px-4 py-2 border border-neglasari-border rounded-xl focus:ring-neglasari-accent focus:border-neglasari-accent">
                ...
                <div>
                    ...
                    <input type="number" name="maximum_accuracy_meters" id="maximum_accuracy_meters" value="{{ old('maximum_accuracy_meters', $location->maximum_accuracy_meters) }}" min="1" required class="w-full px-4 py-2 border border-neglasari-border rounded-xl focus:ring-neglasari-accent focus:border-neglasari-accent">
