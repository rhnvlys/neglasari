...
<div class="space-y-6">
    <div class="bg-white rounded-2xl shadow-lg p-6 border border-neglasari-border">
        <h2 class="text-lg font-bold text-neglasari-dark mb-4">Absen Masuk</h2>
        <p class="text-sm text-neglasari-text-secondary mb-6">Pastikan Anda berada di lokasi kantor dan ambil foto selfie untuk absen.</p>
        
        <div id="map" class="h-64 w-full rounded-xl border border-neglasari-border mb-6"></div>
        
        <form id="checkinForm" method="POST" action="{{ route('pegawai.attendance.checkin') }}" enctype="multipart/form-data">
            @csrf
